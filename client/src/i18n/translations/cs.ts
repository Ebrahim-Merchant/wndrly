const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Společníci na cestě s Wndrly',
  'settings.about.supporters.subtitle': 'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost Wndrly. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby Wndrly zůstal Open Source.',
  ...
  'settings.about.description': 'Wndrly je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
  ...
  'login.createAdminHint': 'Nastavte první administrátorský účet pro Wndrly.',
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si Wndrly.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj Wndrly',

  // Počasí (Weather)
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description': 'Wndrly používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'Wndrly {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText': 'Wndrly bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText': 'Váš Wndrly běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  ...
  'vacay.sharingHint': 'Sdílejte svůj plán dovolené s ostatními uživateli Wndrly',
  'vacay.owner': 'Vlastník',
  'vacay.shareEmailPlaceholder': 'E-mail uživatele Wndrly',
  ...
  'vacay.inviteHint': 'Pozvěte jiného uživatele Wndrly ke sdílení společného kalendáře dovolených.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} je nyní k dispozici.',
  ...
  'notif.version_available.text': 'Wndrly {version} je nyní dostupný',
  ...
  'journey.pdf.madeWith': 'Vytvořeno pomocí Wndrly',
  'journey.pdf.day': 'Den',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Vítejte v Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním Wndrly',
  ...
  'system_notice.v3_photos.body': '**Fotografie** v Plánovacím nástroji byly odebrány. Vaše fotografie jsou v bezpečí — Wndrly nikdy neupravoval vaši knihovnu Immich nebo Synology.\n\nFotografie jsou nyní dostupné v doplňku **Journey**. Journey je volitelný — pokud ještě není k dispozici, požádejte svého správce, aby ho aktivoval v Admin → Doplňky.',
