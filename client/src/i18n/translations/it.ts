const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Compagni di viaggio per Wndrly',
  'settings.about.supporters.subtitle': 'Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di Wndrly. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite — per mantenere Wndrly Open Source.',
  ...
  'settings.about.description': 'Wndrly è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all\'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.',
  ...
  'login.createAdminHint': 'Imposta il primo account amministratore per Wndrly.',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza Wndrly.',
  ...
  'admin.weather.description': 'Wndrly utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare Wndrly',

  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'Wndrly {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText': 'Wndrly verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText': 'La tua istanza Wndrly è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti Wndrly',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': 'Email dell\'utente Wndrly',
  ...
  'vacay.inviteHint': 'Invita un altro utente Wndrly a condividere un calendario ferie combinato.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} è ora disponibile.',
  ...
  'notif.version_available.text': 'Wndrly {version} è ora disponibile',
  ...
  'journey.pdf.madeWith': 'Creato con Wndrly',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Benvenuto su Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinazione di viaggio panoramica con l\'interfaccia Wndrly',
  ...
  'system_notice.v3_photos.body': '**Foto** nel Pianificatore di Viaggio sono state rimosse. Le tue foto sono al sicuro — Wndrly non ha mai modificato la tua libreria Immich o Synology.\n\nLe foto ora si trovano nel componente aggiuntivo **Journey**. Journey è opzionale — se non è ancora disponibile, chiedi al tuo admin di abilitarlo in Admin → Addon.',
