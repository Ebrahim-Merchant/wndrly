const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Travel companions for Wndrly',
  'settings.about.supporters.subtitle': "While you're planning your next route, these folks are helping plan Wndrly's future. Their monthly contribution goes straight into development and real hours spent — so Wndrly stays Open Source.",
  ...
  'settings.about.description': 'Wndrly is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  ...
  'login.createAdminHint': 'Set up the first admin account for Wndrly.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your Wndrly experience.',
  ...
  'admin.weather.description': 'Wndrly uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building Wndrly',

  'admin.update.available': 'Update available',
  'admin.update.text': 'Wndrly {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText': 'Wndrly will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText': 'Your Wndrly instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'vacay.sharingHint': 'Share your vacation plan with other Wndrly users',
  'vacay.owner': 'Owner',
  'vacay.shareEmailPlaceholder': 'Email of Wndrly user',
  ...
  'vacay.inviteHint': 'Invite another Wndrly user to share a combined vacation calendar.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} is now available.',
  ...
  'notif.version_available.text': 'Wndrly {version} is now available',
  ...
  'journey.pdf.madeWith': 'Made with Wndrly',
  'journey.pdf.day': 'Day',
  ...
  'system_notice.v3_photos.body': '**Photos** in the Trip Planner have been removed. Your photos are safe — Wndrly never modified your Immich or Synology library.\n\nPhotos now live in the **Journey** addon. Journey is optional — if it is not yet available, ask your admin to enable it under Admin → Addons.',
  ...
  'system_notice.v3_thankyou.body': 'Before you go — I want to take a moment.\n\nWndrly started as a side project I built for my own trips. I never imagined it would grow into something that 4,000 of you now trust to plan your adventures. Every star, every issue, every feature request — I read them all, and they keep me going through late nights between a full-time job and university.\n\nI want you to know: Wndrly will always be open source, always self-hosted, always yours. No tracking, no subscriptions, no strings attached. Just a tool built by someone who loves traveling as much as you do.\n\nSpecial thanks to [jubnl](https://github.com/jubnl) — you have become an incredible collaborator. So much of what makes 3.0 great carries your fingerprints. Thank you for believing in this project when it was still rough around the edges.\n\nAnd to every single one of you who filed a bug, translated a string, shared Wndrly with a friend, or simply used it to plan a trip — **thank you**. You are the reason this exists.\n\nHere\'s to many more adventures together.\n\n— Maurice\n\n---\n\n[Join the community on Discord](https://discord.gg/7Q6M6jDwzf)\n\nIf Wndrly makes your travels better, a [small coffee](https://ko-fi.com/mauriceboe) always keeps the lights on.',
  ...
  'system_notice.welcome_v1.title': 'Welcome to Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with Wndrly planning UI overlay',
