const zh: Record<string, string> = {
  ...
  'settings.about.supporters.title': '与 Wndrly 同行的伙伴',
  'settings.about.supporters.subtitle': '当你在规划下一段路线时，这些人也在一起规划 Wndrly 的未来。他们每月的支持直接用于开发与真实投入的时间——让 Wndrly 保持开源。',
  ...
  'settings.about.description': 'Wndrly 是一个自托管的旅行规划工具，帮助你从最初的想法到最后的回忆，全程组织你的旅行。日程规划、预算、行李清单、照片等——一切尽在一处，在你自己的服务器上。',
  ...
  'login.createAdminHint': '为 Wndrly 设置第一个管理员账户。',
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 Wndrly 体验。',
  ...
  'admin.weather.description': 'Wndrly 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.github.support': '帮助我继续开发 Wndrly',
  'admin.github.error': '加载版本失败',
  'admin.github.by': '作者',

  'admin.update.available': '有可用更新',
  'admin.update.text': 'Wndrly {version} 已发布。你当前使用的是 {current}。',
  'admin.update.button': '在 GitHub 查看',
  'admin.update.install': '安装更新',
  'admin.update.confirmTitle': '确定安装更新？',
  'admin.update.confirmText': 'Wndrly 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'admin.update.dockerText': '你的 Wndrly 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '与其他 Wndrly 用户共享你的假期计划',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'Wndrly 用户邮箱',
  ...
  'vacay.inviteHint': '邀请其他 Wndrly 用户共享合并的假期日历。',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} 现已可用。',
  ...
  'notif.version_available.text': 'Wndrly {version} 现已可用',
  ...
  'journey.pdf.madeWith': '由 Wndrly 制作',
  'journey.pdf.day': '第',
  ...
  'system_notice.v3_photos.body': '行程规划器中的​**照片**标签已被移除。您的照片安全无虑 — Wndrly 从未修改您的 Immich 或 Synology 相册。\n\n照片现在位于 **Journey** 插件中。Journey 是可选的 — 如果尚未启用，请联系管理员在 Admin → 插件 中开启。',
  ...
  'system_notice.v3_thankyou.body': '在你继续之前——我想停下来说几句。\n\nWndrly 最初只是我为自己的旅行而做的一个业余项目。我从未想过它会成长为 4,000 人信赖的冒险规划工具。每一颗星标、每一个 issue、每一个功能请求——我都会读，它们在全职工作和大学学业之间的深夜里支撑着我继续前行。\n\n我想让你们知道：Wndrly 将永远开源，永远可自托管，永远属于你们。没有追踪，没有订阅，没有任何附加条件。只是一个热爱旅行的人为同样热爱旅行的你们打造的工具。\n\n特别感谢 [jubnl](https://github.com/jubnl)——你已经成为一位不可思议的合作者。3.0 版本中许多精彩之处都留下了你的印记。感谢你在这个项目还很粗糙的时候就选择了相信它。\n\n也感谢你们每一位——报告了 bug、翻译了文本、向朋友分享了 Wndrly，或者只是用它规划了一次旅行——**谢谢你们**。你们是这一切存在的原因。\n\n愿我们一起踏上更多的冒险旅程。\n\n— Maurice\n\n---\n\n[加入 Discord 社区](https://discord.gg/7Q6M6jDwzf)\n\n如果 Wndrly 让你的旅行更美好，一杯[小小的咖啡](https://ko-fi.com/mauriceboe)能让这盏灯一直亮着。',
