const es: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compañía de viaje para Wndrly',
  'settings.about.supporters.subtitle': 'Mientras planeas tu próxima ruta, estas personas ayudan a planear el futuro de Wndrly. Su aporte mensual va directo al desarrollo y a las horas reales invertidas — para que Wndrly siga siendo Open Source.',
  ...
  'settings.about.description': 'Wndrly es un planificador de viajes autoalojado que te ayuda a organizar tus viajes desde la primera idea hasta el último recuerdo. Planificación diaria, presupuesto, listas de equipaje, fotos y mucho más — todo en un solo lugar, en tu propio servidor.',
  ...
  'login.createAdminHint': 'Configura la primera cuenta administradora de Wndrly.',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en Wndrly.',
  ...
  'admin.weather.description': 'Wndrly utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando Wndrly',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'Wndrly {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText': 'Wndrly se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText': 'Tu instancia de Wndrly se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  ...
  'vacay.sharingHint': 'Comparte tu calendario de vacaciones con otros usuarios de Wndrly',
  'vacay.owner': 'Propietario',
  'vacay.shareEmailPlaceholder': 'Correo electrónico del usuario de Wndrly',
  ...
  'vacay.inviteHint': 'Invita a otro usuario de Wndrly a compartir un calendario combinado de vacaciones.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} ya está disponible.',
  ...
  'notif.version_available.text': 'Wndrly {version} ya está disponible',
  ...
  'journey.pdf.madeWith': 'Hecho con Wndrly',
  'journey.pdf.day': 'Día',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenido a Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de Wndrly',
  ...
  'system_notice.v3_photos.body': '**Fotos** en el Planificador de Viajes han sido eliminadas. Tus fotos están a salvo — Wndrly nunca modificó tu biblioteca de Immich o Synology.\n\nLas fotos ahora viven en el addon **Journey**. Journey es opcional — si aún no está disponible, pide a tu admin que lo active en Admin → Complementos.',
