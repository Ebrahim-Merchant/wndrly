const nl: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Reisgezelschap voor Wndrly',
  'settings.about.supporters.subtitle': 'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van Wndrly. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat Wndrly Open Source blijft.',
  ...
  'settings.about.description': 'Wndrly is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto\'s en nog veel meer — alles op één plek, op je eigen server.',
  ...
  'login.createAdminHint': 'Stel het eerste beheerdersaccount in voor Wndrly.',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je Wndrly-ervaring aan te passen.',
  ...
  'admin.weather.description': 'Wndrly gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.support': 'Helpt mij Wndrly verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',

  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'Wndrly {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'Wndrly wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText': 'Je Wndrly-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando\'s uit op je server:',
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere Wndrly-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van Wndrly-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere Wndrly-gebruiker uit om een gecombineerde vakantiekalender te delen.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} is nu beschikbaar.',
  ...
  'notif.version_available.text': 'Wndrly {version} is nu beschikbaar',
  ...
  'journey.pdf.madeWith': 'Gemaakt met Wndrly',
  'journey.pdf.day': 'Dag',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Welkom bij Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met Wndrly interface',
  ...
  'system_notice.v3_photos.body': "**Foto's** in de Reisplanner zijn verwijderd. Je foto's zijn veilig — Wndrly heeft je Immich- of Synology-bibliotheek nooit gewijzigd.\n\nFoto's leven nu in de **Journey**-addon. Journey is optioneel — als het nog niet beschikbaar is, vraag je admin het te activeren via Admin → Addons.",
