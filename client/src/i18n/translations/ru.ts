const ru: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Спутники Wndrly',
  'settings.about.supporters.subtitle': 'Пока ты планируешь следующий маршрут, эти люди планируют вместе со мной будущее Wndrly. Их ежемесячный взнос идёт напрямую в разработку и реально потраченные часы — чтобы Wndrly оставался Open Source.',
  ...
  'settings.about.description': 'Wndrly — это самостоятельно размещаемый планировщик путешествий, который помогает организовать поездки от первой идеи до последнего воспоминания. Планирование по дням, бюджет, списки вещей, фото и многое другое — всё в одном месте, на вашем собственном сервере.',
  ...
  'login.createAdminHint': 'Настройте первый аккаунт администратора для Wndrly.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки Wndrly под себя.',
  ...
  'admin.weather.description': 'Wndrly использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку Wndrly',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',

  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия Wndrly {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'Wndrly будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText': 'Ваш экземпляр Wndrly работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями Wndrly',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя Wndrly',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя Wndrly для совместного календаря отпусков.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} теперь доступен.',
  ...
  'notif.version_available.text': 'Wndrly {version} теперь доступен',
  ...
  'journey.pdf.madeWith': 'Сделано с помощью Wndrly',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Добро пожаловать в Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом Wndrly',
  ...
  'system_notice.v3_photos.body': 'Вкладка **Фото** в Планировщике путешествий удалена. Ваши фото в безопасности — Wndrly никогда не изменял вашу библиотеку Immich или Synology.\n\nФото теперь доступны в дополнении **Journey**. Journey необязателен — если он ещё недоступен, попросите администратора включить его в разделе Admin → Дополнения.',
