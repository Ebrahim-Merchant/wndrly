const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Reisebegleitung für Wndrly',
  'settings.about.supporters.subtitle': 'Während du deine nächste Route planst, planen diese Leute mit, wie Wndrly weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit Wndrly Open Source bleibt.',
  ...
  'settings.about.description': 'Wndrly ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  ...
  'login.createAdminHint': 'Erstelle das erste Admin-Konto für Wndrly.',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um Wndrly nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description': 'Wndrly nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, Wndrly weiterzuentwickeln',

  'admin.update.available': 'Update verfügbar',
  'admin.update.text': 'Wndrly {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText': 'Wndrly wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText': 'Deine Wndrly-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  ...
  'vacay.sharingHint': 'Teile deinen Urlaubsplan mit anderen Wndrly-Benutzern',
  'vacay.owner': 'Besitzer',
  'vacay.shareEmailPlaceholder': 'E-Mail des Wndrly-Benutzers',
  ...
  'vacay.inviteHint': 'Lade einen anderen Wndrly-Benutzer ein, um einen gemeinsamen Urlaubskalender zu teilen.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} ist jetzt verfügbar.',
  ...
  'notif.version_available.text': 'Wndrly {version} ist jetzt verfügbar',
  ...
  'journey.pdf.madeWith': 'Erstellt mit Wndrly',
  'journey.pdf.day': 'Tag',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Willkommen bei Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malerisches Reiseziel mit Wndrly-Planungs-UI',
  ...
  'system_notice.v3_photos.body': '**Fotos** im Trip-Planer wurden entfernt. Deine Fotos sind sicher — Wndrly hat deine Immich- oder Synology-Bibliothek nie verändert.\n\nFotos befinden sich jetzt im **Journey**-Addon. Journey ist optional — falls es noch nicht verfügbar ist, bitte deinen Admin, es unter Admin → Addons zu aktivieren.',
