const fr: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compagnons de voyage pour Wndrly',
  'settings.about.supporters.subtitle': 'Pendant que tu planifies ton prochain itinéraire, ces personnes aident à planifier l\'avenir de Wndrly. Leur contribution mensuelle va directement au développement et aux heures réellement passées — pour que Wndrly reste Open Source.',
  ...
  'settings.about.description': 'Wndrly est un planificateur de voyage auto-hébergé qui vous aide à organiser vos voyages de la première idée au dernier souvenir. Planification journalière, budget, listes de bagages, photos et bien plus — le tout au même endroit, sur votre propre serveur.',
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour Wndrly.',
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience Wndrly.',
  ...
  'admin.weather.description': 'Wndrly utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de Wndrly',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',

  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'Wndrly {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText': 'Wndrly sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText': 'Votre instance Wndrly fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  ...
  'vacay.sharingHint': 'Partagez votre plan de vacances avec d\'autres utilisateurs Wndrly',
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': 'E-mail de l\'utilisateur Wndrly',
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur Wndrly à partager un calendrier de vacances combiné.',
  ...
  'notifications.versionAvailable.text': 'Wndrly {version} est maintenant disponible.',
  ...
  'notif.version_available.text': 'Wndrly {version} est maintenant disponible',
  ...
  'journey.pdf.madeWith': 'Créé avec Wndrly',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenue sur Wndrly',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destination de voyage pittoresque avec l\'interface Wndrly',
  ...
  'system_notice.v3_photos.body': "**Photos** dans le planificateur ont été supprimées. Tes photos sont en sécurité — Wndrly n'a jamais modifié ta bibliothèque Immich ou Synology.\n\nLes photos vivent désormais dans l'addon **Journey**. Journey est optionnel — s'il n'est pas encore disponible, demande à ton admin de l'activer dans Admin → Modules.",
  ...
  'system_notice.v3_thankyou.body': 'Avant de continuer — je veux prendre un instant.\n\nWndrly a commencé comme un projet perso que j\'ai construit pour mes propres voyages. Je n\'aurais jamais imaginé qu\'il grandirait au point que 4 000 d\'entre vous lui fassent confiance pour planifier vos aventures. Chaque étoile, chaque issue, chaque demande de fonctionnalité — je les lis toutes, et ce sont elles qui me font tenir pendant les nuits blanches entre un travail à temps plein et l\'université.\n\nJe veux que vous sachiez : Wndrly sera toujours open source, toujours auto-hébergé, toujours à vous. Pas de tracking, pas d\'abonnements, pas de conditions cachées. Juste un outil construit par quelqu\'un qui aime voyager autant que vous.\n\nUn merci tout particulier à [jubnl](https://github.com/jubnl) — tu es devenu un collaborateur incroyable. Une grande partie de ce qui rend la 3.0 géniale porte ton empreinte. Merci d\'avoir cru en ce projet quand il était encore brut.\n\nEt à chacun d\'entre vous qui a signalé un bug, traduit une chaîne, partagé Wndrly avec un ami ou simplement l\'a utilisé pour planifier un voyage — **merci**. Vous êtes la raison pour laquelle tout ceci existe.\n\nÀ de nombreuses autres aventures ensemble.\n\n— Maurice\n\n---\n\n[Rejoins la communauté sur Discord](https://discord.gg/7Q6M6jDwzf)\n\nSi Wndrly rend tes voyages meilleurs, un [petit café](https://ko-fi.com/mauriceboe) aide toujours à garder les lumières allumées.',
